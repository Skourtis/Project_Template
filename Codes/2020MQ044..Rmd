...
c_sh1 <-proteus::limmaDE(prodat.med, conditions=c('control','sh_1'))
print(c_sh1)
c_sh2 <- proteus::limmaDE(prodat.med, conditions= c('control', 'sh_2'))
sh1_sh2 <- proteus::limmaDE(prodat.med, conditions= c('sh_1', 'sh_2'))
c_sh1
proteus::plotPdist
...
test1 <-c_sh1short[order(c_sh1short$adj.P.Val),]
test1
test2
test3
...
summary(qobj1)
subset(qobj$qvalues, qobj$qvalues<=0.1,lambda = seq(0.1, 0.95, 0.1),pi0.method='bootstrap')
